...
Router.route('/teacher',{
    ...
    layoutTemplate: 'layout',
    waitOn: function(){
        return [Meteor.subscribe("homeworks"),Meteor.subscribe("userData"), Meteor.subscribe("relationship")];
    },
    onBeforeAction: function(){
...
Router.route('/student',{
    ...
    waitOn: function(){
        ...
        return [Meteor.subscribe("homeworks"),Meteor.subscribe("userData"),Meteor.subscribe("homeworkfiles"), Meteor.subscribe("reviews")];
    },
    onBeforeAction: function(){
